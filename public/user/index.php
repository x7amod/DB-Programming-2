...
<section class="user-search-header">
    ...
    <?php elseif (in_array($current_user['role'], ['Admin', 'Support'], true)): ?>
        <a class="btn-view" href="<?= $root_url ?>/public/admin/index.php">Admin Dashboard</a>
    <?php endif; ?>
</section>

<section class="user-search-panel">
    <form method="GET" action="<?= $root_url ?>/public/user/index.php" class="user-search-form">
        ...
        <div class="user-search-actions">
            ...
            <a class="btn-link" href="<?= $root_url ?>/public/user/index.php">Clear</a>
        </div>
    </form>
</section>
