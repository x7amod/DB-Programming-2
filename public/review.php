...
<section class="comments-section">
	...
	<?php if ($currentUser): ?>
		<form id="comment-form" class="comment-form" method="POST" action="/DB-Programming-2/public/ajax/submit_comment.php" novalidate>
	...
	<?php else: ?>
		<p class="comment-empty">
			You need to <a href="/DB-Programming-2/public/auth/login.php">log in</a> to add a rating or comment.
		</p>
	<?php endif; ?>
</section>
